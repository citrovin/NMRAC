...
%% Parameters Double Flying Arm
% Internal dynamics
l_1 = 0.4; % distance to propeller 1 from origin
l_2 = 0.4; % distance to propeller 2 from origin
d_1 = -0.1;   % distance to CoG
f_r = 0.01;   % Friction term at origin
J = 0.04;     % Inertia
g = 9.81;  % Gravity
mass = 0.5;     % Mass of system
