...
% This file contains the proof of concept simulations for MIMO NMRAC. This
...
BASE_DIR = './results/';
SAVE_DIR = strjoin([BASE_DIR, strjoin(string(ct(1:5)),'-')],'Academic_Example_');
...
% This model will define the desired reference of the controlled system
...
if SAVE_PLOTS == 1
    full_path = char(strcat(SAVE_DIR, '/', 'NMRAC_trajectory'));
    saveas(gcf, [full_path '.png']);
    cleanfigure;
